...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("SkylaChats")
                await self.one.join_chat("SkyXBots")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("SkylaChats")
                await self.two.join_chat("SkyXBots")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("SkylaChats")
                await self.three.join_chat("SkyXBots")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("SkylaChats")
                await self.four.join_chat("SkyXBots")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("SkylaChats")
                await self.five.join_chat("SkyXBots")
            except:
                pass
            assistants.append(5)
            try:
