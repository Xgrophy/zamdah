...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("GrovySupport")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("GrovySupport")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("GrovySupport")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("GrovySupport")
